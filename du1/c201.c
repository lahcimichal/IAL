...
***/
	...
	while ( L -> First != NULL )
	{
		tElemPtr pom ;				/* Vytvoreni pomocneho ukazatele */
		pom = L -> First ;
		L -> First = pom -> ptr ;
		free ( pom ) ;				/* Uvolneni pomocneho ukazatele */
	}

	L -> Act = NULL ;				/* V prazdnem seznamu nemuze byt aktivni prvek */
}
...
**/
	...
	/* Vlozeni noveho prvku na zacatek seznamu */
	new_item -> data = val ;
...
**/
	...
	tElemPtr pom ;					/* Vytvoreni pomocenho ukazatele */
	if ( L -> First != NULL )
	{
		pom = L -> First ;
		L -> First = pom -> ptr ;
		free ( pom ) ;				/* Uvolneni pomocenho ukazatele */
	}
}	
...
**/
	...
	/* Ruseni prvku seznamu za aktivnim prvkem */
	tElemPtr pom ;					/* Vytvoreni pomocneho ukazatele */
	pom = L -> Act -> ptr ;
	L -> Act -> ptr = pom -> ptr ;
	free ( pom ) ;					/* Uvolneni pomocneho ukazatele */
...
**/
	...
	/* Naplneni polozky a jeji umisteni za aktivni prvek */
	new_item -> data = val ;
