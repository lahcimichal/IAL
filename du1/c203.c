...
*/
	...
	/* Nastaveni vsech hodnot na '*' */
	for ( int i = 0 ; i < QUEUE_SIZE ; i++ )
	{
		q -> arr [ i ] = '*' ;
	}

	/* Nastaveni indexu na 0 */
	q -> f_index = 0 ;
	q -> b_index = 0 ;
}
...
*/
	...
	/* Vraceni znaku ze zacatku fronty */
	*c = q -> arr [ q -> f_index ] ;
}
...
*/
	...
	/* Odstraneni znaky ze zacatku fronty */
...
*/
	...
	/* Odstraneni zaku ze zacatku fronty */
	queueRemove ( q ) ;
}
...
*/
	...
	/* Vlozeni znaku do fronty */
	q -> arr [ q -> b_index ] = c ;

	/* Posunuti indexu prvni volne pozice */
